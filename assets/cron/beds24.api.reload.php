...
//Pagina inicial
	...
	set_time_limit(0);
	$db->truncate('360suites_roomids');
	$db->truncate('360suites_roomnames');
	$db->truncate('360suites_roomtexto');
	$db->truncate('360suites_roomvalor');
	...
	echo "API Atualizado com sucesso!";